...
Thread(target=run, args=(f"npx uglify-js {os.path.join(os.getcwd(), 'static', 'frame.js')} -o {os.path.join(os.getcwd(), 'static', 'frame_min.js')}",), kwargs={'shell': True}, name="app.js").start()
